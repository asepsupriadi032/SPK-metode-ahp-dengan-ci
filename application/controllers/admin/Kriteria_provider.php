...
class Kriteria_provider extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "kriteria_provider";
        $this->active_id_menu = "Kriteria provider";
        $this->nama_view      = "Kriteria provider";
        $this->status         = true; 
    ...
    function index(){
		// if($this->crud->getState() == "read")
            ...
            **/
            ...
            $this->crud->set_relation('id_kriteria','kriteria','kriteria');
            $this->crud->set_relation('id_operator','operator','nama_operator');
            /** Upload **/
            ...
            $this->crud->display_as('id_kriteria','Kriteria'); 
            $this->crud->display_as('id_operator','Provider'); 
