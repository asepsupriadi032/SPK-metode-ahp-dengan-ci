...
class Pilihankuisioner extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "pg_kuisioner";
        $this->active_id_menu = "pg_kuisioner";
        $this->nama_view      = "pg_kuisioner";
        $this->status         = true; 
    ...
    function index(){
		// if($this->crud->getState() == "read")
            ...
            **/
            $this->crud->set_relation('id_kuisioner','kuisioner','pertanyaan');
            ...
            // $this->crud->display_as('nama','Nama Setelah di Edit')
               $this->crud->display_as('id_kuisioner','Pertanyaan'); 
               $this->crud->display_as('pg_kuisioner','Pernyataan'); 
